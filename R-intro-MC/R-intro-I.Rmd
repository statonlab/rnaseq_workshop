...
# Install packages
R has many modules of code that you can use. You can explore these through [CRAN](https://cran.r-project.org/). We will download some basic packages to demonstrate how to access those modules. ggplot2 is an R package that does plotting, i.e. creates very nice graphics.
