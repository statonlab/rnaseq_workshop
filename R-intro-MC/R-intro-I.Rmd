...
You can also set to a new location, anywhere in your file system. We want this to be a folder on your Desktop for now. We can do this through the R command.
```{r eval=FALSE}
# For Mac user
