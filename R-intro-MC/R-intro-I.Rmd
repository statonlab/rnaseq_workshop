...
* `[` is similar to `[[`. The difference is that `[[` can only return a single element, while `[[` can return multiple elements.
...
factor_x2
# the vector need to contain values only from categories. Otherwise, it will generate NA
