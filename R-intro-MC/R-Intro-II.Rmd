...
We are going to learn five important functions from the **dplyr** package. These five functions allow you
to do the vast majority of data manipulation.
...
`summarise()` is similar to `mutate()`. You operate on existing variables, creating new variables. Note the new variables have to be single value (hence, summarised).
