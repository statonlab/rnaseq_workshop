...
To complement the differential expression results, annotations are added to each row.
```{r}
myRes.sig = subset(myRes, padj < 0.05)
myRes.sig

## load annotation data
anno <- read.table("Ppersica_298_v2.1.annotation_info.txt", header=TRUE, sep="\t", fill=TRUE)
...
write.csv(myRes.anno, file="myRes_sig.csv")
```
